...
async def get_security_logs(
    ...
    """
    Retrieve security logs (admin only in production, for now accessible to all authenticated users).
    """
...
async def get_access_logs(
    ...
    """
    Retrieve access logs (admin only in production, for now accessible to all authenticated users).
    """
    from sqlalchemy import select
    from sqlalchemy.orm import selectinload
